/*
 * このクラスはThe Android Open Source Projectが
 * Apache License, Version 2.0のもとで公開している
 * RectFクラスのfloat値をdoubleに置き換えたものです。
 */
...
package jp.dai1741.android.graphics;
...
public class RectD implements Parcelable {
    ...
    public void round(Rect dst) {
        dst.set((int) Math.round(left), (int) Math.round(top), (int) Math.round(right),
    ...
    public void roundOut(Rect dst) {
        dst.set((int) Math.floor(left), (int) Math.floor(top), (int) Math.ceil(right),
